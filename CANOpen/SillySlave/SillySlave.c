...
/* index 0x1017 :   Producer Heartbeat Time. */
                    ...
                    subindex SillySlave_Index1017[] = 
                     {
                       { RW, uint16, sizeof (UNS16), (void*)&SillySlave_obj1017 }
                     };
...
const indextable SillySlave_objdict[] = 
{
  ...
  { (subindex*)SillySlave_Index1017,sizeof(SillySlave_Index1017)/sizeof(SillySlave_Index1017[0]), 0x1017},
...
const indextable * SillySlave_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x1017: i = 4;*callbacks = SillySlave_Index1017_callbacks; break;
		case 0x1018: i = 5;break;
		case 0x1200: i = 6;*callbacks = SillySlave_Index1200_callbacks; break;
